...
model Multimachine2 "3MIB Plant model"
  ...
  GenerationUnits.MachineEXPSS.Generator1EXPSS generator1EXPSS(
    ...
    angle_0=pf.powerflow.bus.A1,
    displayPF=false,
    pSSTypeIIExtraLeadLag(Tw=3)) annotation (Placement(transformation(extent={{-162,32},{-136,54}})));
  GenerationUnits.MachineEXPSS.Generator2EXPSS generator2EXPSS(
    ...
    angle_0=pf.powerflow.bus.A2,
    displayPF=false,
    pSSTypeIIExtraLeadLag(Tw=10)) annotation (Placement(transformation(extent={{-162,-12},{-136,10}})));
  GenerationUnits.MachineEXPSS.Generator3EXPSS generator3EXPSS(
    ...
    angle_0=pf.powerflow.bus.A3,
    displayPF=false,
    pSSTypeIIExtraLeadLag(Tw=10)) annotation (Placement(transformation(extent={{-160,-56},{-134,-34}})));
