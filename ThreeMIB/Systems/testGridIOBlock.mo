...
equation
  connect(pulse.y, grid.uPload1) annotation (Line(points={{-68.6,38},{-42,38},{-42,18.5143},{-22.1,18.5143}},    color={0,0,127}));
  ...
  connect(grid.uPm1, zero.y) annotation (Line(points={{-22,12.1714},{-22,20},{-58,20},{-58,-4},{-62,-4},{-62,-15},{-66.2,-15}},           color={0,0,127}));
  ...
  connect(grid.uvs3, zero.y) annotation (Line(points={{-22,-10.5714},{-60,-10.5714},{-60,-10},{-58,-10},{-58,-9.15789},{-62,-9.15789},{-62,-15},{-66.2,-15}},      color={0,0,127}));
  connect(grid.uPload2, zero.y) annotation (Line(points={{-22.1,-13.6},{-60,
          -13.6},{-60,-10},{-58,-10},{-58,-9.15789},{-62,-9.15789},{-62,-15},{
          -66.2,-15}},                                                                                                                                                color={0,0,127}));
  connect(grid.uPload3, zero.y) annotation (Line(points={{-22.1,-16.4571},{-60,-16.4571},{-60,-10},{-58,-10},{-58,-9.15789},{-62,-9.15789},{-62,-15},{-66.2,-15}},    color={0,0,127}));
